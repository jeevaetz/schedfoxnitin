 ...
 * @author user
 */
public class get_all_active_clients_with_extras_query extends GeneralQueryFormat {
    ...
    public String getPreparedStatementString() {
        ...
        sql.append("FROM ");
        sql.append("client ");
        sql.append("LEFT JOIN champion_db.dynamic_field_value ON dynamic_field_value.dynamic_field_def_id = 8 AND dynamic_field_value.key_for_value = client.client_id ");
        sql.append("WHERE ");
