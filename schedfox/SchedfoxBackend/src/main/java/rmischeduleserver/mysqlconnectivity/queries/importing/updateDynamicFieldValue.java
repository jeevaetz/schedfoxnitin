 ...
 * @author vnguyen
 */
public class updateDynamicFieldValue extends GeneralQueryFormat{
    ...
    public updateDynamicFieldValue(String val, int dynamic_field_def_id, int last_user_changed, int id){
    ...
    public String toString(){
        ...
        sb.append("UPDATE dynamic_field_value ");
        sb.append("SET dynamic_field_value= '"+this.dynamic_field_value + "' ");
        sb.append(" WHERE key_for_value = "+this.key_for_value);
        return sb.toString();
    }
