 ...
 * @author user
 */
public class get_way_point_scans_for_client_and_timezone_query extends GeneralQueryFormat {
    ...
    public void update(Date start, Date end, Integer clientId, String timezone) {
        SimpleDateFormat myFormat = new SimpleDateFormat("yyyy-MM-dd");
        
        super.setPreparedStatement(timezone, timezone, myFormat.format(start), myFormat.format(end), clientId);
    }
