 ...
 * @author ira
 */
public class get_daily_report_by_employee_id_query extends GeneralQueryFormat {
    ...
    public String getPreparedStatementString() {
        ...
        sql.append("WHERE ");
        sql.append("employee_id = ? AND logged_in > NOW() - interval '12 hour' AND logged_out IS NULL ");
        return sql.toString();
    }
