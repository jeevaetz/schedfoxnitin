 ...
 * @author Ira Juneau
 */
public class get_missed_checkins_for_client_contacts_query extends GeneralQueryFormat {
    ...
    public String getPreparedStatementString() {
        ...
        sql.append("LEFT JOIN checkin_notifications ON checkin_notifications.shift_id = mydata.sid AND client_contact_id != 0 ");
        ...
        sql.append("mydata.lu < NOW() - interval '1 minutes' * (client.notify_dm_late_checkout_minutes * 2) AND ");
        sql.append("(extract (hour from mytime.timezone) * 60 + extract (minute from mytime.timezone)) >= (mydata.start_time + (client.notify_dm_late_checkout_minutes * 2)) AND ");
