 ...
 * @author user
 */
public class get_contact_client_contract_query extends GeneralQueryFormat {
    ...
    public String getPreparedStatementString() {
        ...
        sql.append("branch.branch_id, client.client_id, client.client_name, client.client_address, client_city, client_state, client_zip, client_contract.*, client.client_id, client.client_start_date ");
