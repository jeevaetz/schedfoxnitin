 ...
 * @author ira
 */
public class get_events_with_followup_query extends GeneralQueryFormat {

    private int size;
    
    public get_events_with_followup_query() {
    ...
    public void update(Date startDate, Date endDate, ArrayList<Integer> ints) {
        this.size = ints.size();
